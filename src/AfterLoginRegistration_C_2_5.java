...
public class AfterLoginRegistration_C_2_5 {
    ...
    public AfterLoginRegistration_C_2_5(){
        ...
        createOrderButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                if(e.getSource()==createOrderButton){
                    frame.dispose();
                    CreateOrder_C_3_A createOrder = new CreateOrder_C_3_A();
                }
            }
        });
        ...
        returnItemButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                if(e.getSource()==returnItemButton){
                    frame.dispose();
                    ReturnItem_C_4_ returnItem = new ReturnItem_C_4_();
                }
            }
        });
        ...
        orderHistoryButton.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e){
                if(e.getSource()==orderHistoryButton){
                    frame.dispose();
                    OrderHistory_C_5_A orderHistory = new OrderHistory_C_5_A();
                }
            }
        });
